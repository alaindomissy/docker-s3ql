...
RUN wget -nv -O /usr/src/s3ql-2.13.tar.bz2  https://bitbucket.org/nikratio/s3ql/downloads/s3ql-2.13.tar.bz2
RUN tar xvj -C /usr/src -f /usr/src/s3ql-2.13.tar.bz2
WORKDIR /usr/src/s3ql-2.13
